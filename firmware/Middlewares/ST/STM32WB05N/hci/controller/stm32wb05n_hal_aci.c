/**
  ******************************************************************************
  * @file    stm32wb05n_hal_aci.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version V1.3.0
  * @date    06-Feb-2024
  * @brief   Source file for external uC - STM32WB05N in network coprocessor mode (hal_aci)
                                   ...
                                   uint16_t Link_Connection_Handle[16 / 2])
{
  ...
  STM32WB_memcpy((void *) Link_Status, (const void *) resp.Link_Status, 8);
  STM32WB_memcpy((void *) Link_Connection_Handle, (const void *) resp.Link_Connection_Handle, 16);
  return BLE_STATUS_SUCCESS;
}
                                         ...
                                         uint8_t Data[])
{
  ...
  STM32WB_memcpy((void *) Data, (const void *) resp.Data, (rq.rlen-1)*sizeof(uint8_t));
  return BLE_STATUS_SUCCESS;
}
                                   ...
                                   uint8_t Data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->Data, (const void *) Data, Num_Bytes*sizeof(uint8_t));
