/**
  ******************************************************************************
  * @file    stm32wb05n_events.c
  * @author  AMS - RF Application team
  * @version V1.4.0
  * @date    26 July 2024
  * @brief   Source file for external uC - STM32WB05N in network coprocessor mode
...
const hci_le_meta_events_table_type hci_le_meta_events_table[40] = {
  ...
  {0x000b, hci_le_directed_advertising_report_event_process},
  ...
  {0x0024, hci_le_periodic_advertising_sync_established_v2_event_process},
  /* hci_le_periodic_advertising_report_v2_event */
  {0x0025, hci_le_periodic_advertising_report_v2_event_process},
  /* hci_le_periodic_advertising_sync_transfer_received_v2_event */
  {0x0026, hci_le_periodic_advertising_sync_transfer_received_v2_event_process},
  /* hci_le_periodic_advertising_subevent_data_request_event */
  {0x0027, hci_le_periodic_advertising_subevent_data_request_event_process},
  /* hci_le_periodic_advertising_response_report_event */
  {0x0028, hci_le_periodic_advertising_response_report_event_process},
  /* hci_le_enhanced_connection_complete_v2_event */
  {0x0029, hci_le_enhanced_connection_complete_v2_event_process},
};
const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[46] = {
  ...
  {0x0402, aci_gap_passkey_req_event_process},
  ...
  {0x040b, aci_gap_pairing_event_process},
  ...
  /* aci_l2cap_cos_disconnection_complete_event */
  {0x0804, aci_l2cap_cos_disconnection_complete_event_process},
  /* aci_l2cap_cos_flow_control_credit_event */
  {0x0805, aci_l2cap_cos_flow_control_credit_event_process},
  /* aci_l2cap_cos_sdu_data_tx_event */
  {0x0806, aci_l2cap_cos_sdu_data_tx_event_process},
  /* aci_l2cap_cos_sdu_data_rx_nwk_event */
  {0x0807, aci_l2cap_cos_sdu_data_rx_nwk_event_process},
  /* aci_l2cap_cos_reconfiguration_event */
  {0x0809, aci_l2cap_cos_reconfiguration_event_process},
  /* aci_l2cap_command_reject_event */
  {0x080a, aci_l2cap_command_reject_event_process},
  /* aci_l2cap_cos_connection_req_event */
  {0x080e, aci_l2cap_cos_connection_req_event_process},
  /* aci_l2cap_cos_connection_resp_event */
  {0x080f, aci_l2cap_cos_connection_resp_event_process},
...
/* aci_l2cap_cos_reconfiguration_event */
/* Event len: 2 + 1 + 2 + 1 + 2 + 2 + 1 + rp0->CID_Count * (sizeof(uint16_t)) */
/**
...
/* hci_le_create_big_complete_event */
/* Event len: 1 + 1 + 3 + 3 + 1 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + rp0->Num_BIS * (sizeof(uint16_t)) */
/**
...
/* hci_le_big_sync_established_event */
/* Event len: 1 + 1 + 3 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + rp0->Num_BIS * (sizeof(uint16_t)) */
/**
