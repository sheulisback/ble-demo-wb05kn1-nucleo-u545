/**
  ******************************************************************************
  * @file    stm32wb05n_hci_le.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version V1.4.0
  * @date    06-May-2024
  * @brief   Source file for external uC - STM32WB05N in network coprocessor
...
tBleStatus hci_set_event_mask(uint8_t Event_Mask[8])
{
  ...
  tBleStatus status = 0;
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->Event_Mask, (const void *) Event_Mask, 8);
  index_input += 8;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x03;
  rq.ocf = 0x001;
...
tBleStatus hci_set_event_mask_page_2(uint8_t Event_Mask_Page_2[8])
{
  ...
  tBleStatus status = 0;
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->Event_Mask_Page_2, (const void *) Event_Mask_Page_2, 8);
  index_input += 8;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x03;
  rq.ocf = 0x063;
...
tBleStatus hci_read_local_supported_commands(uint8_t Supported_Commands[64])
{
  ...
  STM32WB_memcpy((void *) Supported_Commands, (const void *) resp.Supported_Commands, 64);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_read_local_supported_features(uint8_t LMP_Features[8])
{
  ...
  STM32WB_memcpy((void *) LMP_Features, (const void *) resp.LMP_Features, 8);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_read_bd_addr(uint8_t BD_ADDR[6])
{
  ...
  STM32WB_memcpy((void *) BD_ADDR, (const void *) resp.BD_ADDR, 6);
  return BLE_STATUS_SUCCESS;
}
...
tBleStatus hci_le_read_local_supported_features(uint8_t LE_Features[8])
{
  ...
  STM32WB_memcpy((void *) LE_Features, (const void *) resp.LE_Features, 8);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_le_set_random_address(uint8_t Random_Address[6])
{
  ...
  tBleStatus status = 0;
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->Random_Address, (const void *) Random_Address, 6);
  index_input += 6;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x005;
                                       ...
                                       uint8_t Advertising_Data[31])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Advertising_Data, (const void *) Advertising_Data, 31);
  index_input += 31;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x008;
                                         ...
                                         uint8_t Scan_Response_Data[31])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Scan_Response_Data, (const void *) Scan_Response_Data, 31);
  index_input += 31;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x009;
...
tBleStatus hci_le_read_filter_accept_list_size(uint8_t *Filter_Accept_List_Size)
{
  ...
  *Filter_Accept_List_Size = btoh(resp.Filter_Accept_List_Size, 1);
  return BLE_STATUS_SUCCESS;
}
...
tBleStatus hci_le_set_host_channel_classification(uint8_t LE_Channel_Map[5])
{
  ...
  tBleStatus status = 0;
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->LE_Channel_Map, (const void *) LE_Channel_Map, 5);
  index_input += 5;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x014;
                                   ...
                                   uint8_t LE_Channel_Map[5])
{
  ...
  STM32WB_memcpy((void *) LE_Channel_Map, (const void *) resp.LE_Channel_Map, 5);
  return BLE_STATUS_SUCCESS;
}
                          ...
                          uint8_t Encrypted_Data[16])
{
  ...
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->Key, (const void *) Key, 16);
  index_input += 16;
  STM32WB_memcpy((void *) &cp0->Plaintext_Data, (const void *) Plaintext_Data, 16);
  index_input += 16;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x017;
  ...
  STM32WB_memcpy((void *) Encrypted_Data, (const void *) resp.Encrypted_Data, 16);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_le_rand(uint8_t Random_Number[8])
{
  ...
  STM32WB_memcpy((void *) Random_Number, (const void *) resp.Random_Number, 8);
  return BLE_STATUS_SUCCESS;
}
                                    ...
                                    uint8_t Long_Term_Key[16])
{
  ...
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  STM32WB_memcpy((void *) &cp0->Random_Number, (const void *) Random_Number, 8);
  index_input += 8;
  cp0->Encrypted_Diversifier = htob(Encrypted_Diversifier, 2);
  index_input += 2;
  STM32WB_memcpy((void *) &cp0->Long_Term_Key, (const void *) Long_Term_Key, 16);
  index_input += 16;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x019;
...
tBleStatus hci_le_read_supported_states(uint8_t LE_States[8])
{
  ...
  STM32WB_memcpy((void *) LE_States, (const void *) resp.LE_States, 8);
  return BLE_STATUS_SUCCESS;
}
...
tBleStatus hci_le_generate_dhkey(uint8_t Remote_P256_Public_Key[64])
{
  ...
  tBleStatus status = 0;
  uint8_t index_input = 0;
  STM32WB_memcpy((void *) &cp0->Remote_P256_Public_Key, (const void *) Remote_P256_Public_Key, 64);
  index_input += 64;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x026;
                                               ...
                                               uint8_t Local_IRK[16])
{
  ...
  index_input += 6;
  STM32WB_memcpy((void *) &cp0->Peer_IRK, (const void *) Peer_IRK, 16);
  index_input += 16;
  STM32WB_memcpy((void *) &cp0->Local_IRK, (const void *) Local_IRK, 16);
  index_input += 16;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x027;
                                               ...
                                               uint8_t Peer_Resolvable_Address[6])
{
  ...
  STM32WB_memcpy((void *) Peer_Resolvable_Address, (const void *) resp.Peer_Resolvable_Address, 6);
  return BLE_STATUS_SUCCESS;
}
                                                ...
                                                uint8_t Local_Resolvable_Address[6])
{
  ...
  STM32WB_memcpy((void *) Local_Resolvable_Address, (const void *) resp.Local_Resolvable_Address, 6);
  return BLE_STATUS_SUCCESS;
}
                                                     ...
                                                     uint8_t Advertising_Random_Address[6])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Advertising_Random_Address, (const void *) Advertising_Random_Address, 6);
  index_input += 6;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x035;
                                                      ...
                                                      int8_t *Selected_Tx_Power)
{
  ...
  index_input += 2;
  STM32WB_memcpy((void *) &cp0->Primary_Advertising_Interval_Min, (const void *) Primary_Advertising_Interval_Min, 3);
  index_input += 3;
  STM32WB_memcpy((void *) &cp0->Primary_Advertising_Interval_Max, (const void *) Primary_Advertising_Interval_Max, 3);
  index_input += 3;
                                             ...
                                             Extended_Create_Connection_Parameters_t Extended_Create_Connection_Parameters[])
{
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < len; i++) {
      ...
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Connection_Interval_Min = Extended_Create_Connection_Parameters[i].Connection_Interval_Min;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Connection_Interval_Max = Extended_Create_Connection_Parameters[i].Connection_Interval_Max;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Max_Latency = Extended_Create_Connection_Parameters[i].Max_Latency;
      index_input += 2;
      ...
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Min_CE_Length = Extended_Create_Connection_Parameters[i].Min_CE_Length;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Max_CE_Length = Extended_Create_Connection_Parameters[i].Max_CE_Length;
      index_input += 2;
    }
  }
  STM32WB_memset(&rq, 0, sizeof(rq));
                                                   ...
                                                   uint8_t Sync_CTE_Type)
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Advertiser_Address, (const void *) Advertiser_Address, 6);
  index_input += 6;
                                                              ...
                                                              uint8_t Advertising_SID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_remove_device_from_periodic_advertiser_list_cp0 *cp0 = (hci_le_remove_device_from_periodic_advertiser_list_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Advertiser_Address_Type = htob(Advertiser_Address_Type, 1);
  index_input += 1;
                                   ...
                                   uint8_t Antenna_IDs[])
{
  ...
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->Antenna_IDs, (const void *) Antenna_IDs, Switching_Pattern_Length*sizeof(uint8_t));
                                   ...
                                   uint8_t Time_Offset[3])
{
  ...
  *TX_Time_Stamp = btoh(resp.TX_Time_Stamp, 4);
  STM32WB_memcpy((void *) Time_Offset, (const void *) resp.Time_Offset, 3);
  return BLE_STATUS_SUCCESS;
}
                                     ...
                                     uint16_t Connection_Handle[])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->SDU_Interval_C_To_P, (const void *) SDU_Interval_C_To_P, 3);
  index_input += 3;
  STM32WB_memcpy((void *) &cp0->SDU_Interval_P_To_C, (const void *) SDU_Interval_P_To_C, 3);
  index_input += 3;
  ...
  STM32WB_memcpy((void *) Connection_Handle, (const void *) resp.Connection_Handle, CIS_Count*sizeof(uint16_t));
  return BLE_STATUS_SUCCESS;
}
                             ...
                             uint8_t Broadcast_Code[16])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->SDU_Interval, (const void *) SDU_Interval, 3);
  index_input += 3;
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Broadcast_Code, (const void *) Broadcast_Code, 16);
  index_input += 16;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x068;
                                  ...
                                  uint8_t BIS[])
{
  ...
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->BIS, (const void *) BIS, Num_BIS*sizeof(uint8_t));
    index_input += Num_BIS*sizeof(uint8_t);
  }
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x06b;
                                      ...
                                      uint8_t Codec_Configuration[])
{
  ...
  index_input += 1;
  STM32WB_memcpy((void *) &cp0->Codec_ID, (const void *) Codec_ID, 5);
  index_input += 5;
  STM32WB_memcpy((void *) &cp0->Controller_Delay, (const void *) Controller_Delay, 3);
  index_input += 3;
  cp0->Codec_Configuration_Length = htob(Codec_Configuration_Length, 1);
  index_input += 1;
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->Codec_Configuration, (const void *) Codec_Configuration, Codec_Configuration_Length*sizeof(uint8_t));
                                                         ...
                                                         int8_t *Selected_Tx_Power)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_extended_advertising_parameters_v2_cp0 *cp0 = (hci_le_set_extended_advertising_parameters_v2_cp0*)(cmd_buffer);
  hci_le_set_extended_advertising_parameters_v2_rp0 resp;
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
  ...
  cp0->Scan_Request_Notification_Enable = htob(Scan_Request_Notification_Enable, 1);
  index_input += 1;
  cp0->Primary_Advertising_PHY_Options = htob(Primary_Advertising_PHY_Options, 1);
  index_input += 1;
  cp0->Secondary_Advertising_PHY_Options = htob(Secondary_Advertising_PHY_Options, 1);
  index_input += 1;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x07f;
                                                         ...
                                                         Subevent_Data_Parameters_t Subevent_Data_Parameters[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_periodic_advertising_subevent_data_cp0 *cp0 = (hci_le_set_periodic_advertising_subevent_data_cp0*)(cmd_buffer);
  hci_le_set_periodic_advertising_subevent_data_rp0 resp;
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
  cp0->Num_Subevents = htob(Num_Subevents, 1);
  index_input += 1;
  /* var_len_data input */
  {
    for (int i = 0; i < Num_Subevents; i++) {
      packed_Subevent_Data_Parameters_t *Subevent_Data_Parameters_tmp = (packed_Subevent_Data_Parameters_t *)(((uint8_t *)cmd_buffer) + index_input);
      Subevent_Data_Parameters_tmp->Subevent = Subevent_Data_Parameters[i].Subevent;
      index_input += 1;
      Subevent_Data_Parameters_tmp->Response_Slot_Start = Subevent_Data_Parameters[i].Response_Slot_Start;
      index_input += 1;
      Subevent_Data_Parameters_tmp->Response_Slot_Count = Subevent_Data_Parameters[i].Response_Slot_Count;
      index_input += 1;
      Subevent_Data_Parameters_tmp->Subevent_Data_Length = Subevent_Data_Parameters[i].Subevent_Data_Length;
      index_input += 1;
      STM32WB_memcpy(Subevent_Data_Parameters_tmp->Subevent_Data, Subevent_Data_Parameters[i].Subevent_Data, Subevent_Data_Parameters[i].Subevent_Data_Length);
      index_input += Subevent_Data_Parameters[i].Subevent_Data_Length;
    }
  }
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
                                                         ...
                                                         uint8_t Response_Data[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_periodic_advertising_response_data_cp0 *cp0 = (hci_le_set_periodic_advertising_response_data_cp0*)(cmd_buffer);
  hci_le_set_periodic_advertising_response_data_rp0 resp;
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Sync_Handle = htob(Sync_Handle, 2);
  index_input += 2;
  cp0->Request_Event = htob(Request_Event, 2);
  index_input += 2;
  cp0->Request_Subevent = htob(Request_Subevent, 1);
  index_input += 1;
  cp0->Response_Subevent = htob(Response_Subevent, 1);
  index_input += 1;
  cp0->Response_Slot = htob(Response_Slot, 1);
  index_input += 1;
  cp0->Response_Data_Length = htob(Response_Data_Length, 1);
  index_input += 1;
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->Response_Data, (const void *) Response_Data, Response_Data_Length*sizeof(uint8_t));
    index_input += Response_Data_Length*sizeof(uint8_t);
  }
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x083;
                                             ...
                                             uint8_t Subevent[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_periodic_sync_subevent_cp0 *cp0 = (hci_le_set_periodic_sync_subevent_cp0*)(cmd_buffer);
  hci_le_set_periodic_sync_subevent_rp0 resp;
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Sync_Handle = htob(Sync_Handle, 2);
  index_input += 2;
  ...
  /* var_len_data input */
  {
    STM32WB_memcpy((void *) &cp0->Subevent, (const void *) Subevent, Num_Subevents*sizeof(uint8_t));
    index_input += Num_Subevents*sizeof(uint8_t);
  }
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x084;
                                                ...
                                                Extended_Create_Connection_Parameters_t Extended_Create_Connection_Parameters[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_extended_create_connection_v2_cp0 *cp0 = (hci_le_extended_create_connection_v2_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
                                                         ...
                                                         uint8_t Num_Response_Slots)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_periodic_advertising_parameters_v2_cp0 *cp0 = (hci_le_set_periodic_advertising_parameters_v2_cp0*)(cmd_buffer);
  hci_le_set_periodic_advertising_parameters_v2_rp0 resp;
  STM32WB_memset(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
  ...
  cp0->Num_Subevents = htob(Num_Subevents, 1);
  index_input += 1;
  cp0->Subevent_Interval = htob(Subevent_Interval, 1);
  index_input += 1;
  cp0->Response_Slot_Delay = htob(Response_Slot_Delay, 1);
  index_input += 1;
  cp0->Response_Slot_Spacing = htob(Response_Slot_Spacing, 1);
  index_input += 1;
  cp0->Num_Response_Slots = htob(Num_Response_Slots, 1);
  index_input += 1;
  STM32WB_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x086;
