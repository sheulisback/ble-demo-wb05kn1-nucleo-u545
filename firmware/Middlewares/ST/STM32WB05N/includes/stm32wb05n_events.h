/**
  ******************************************************************************
  * @file    stm32wb05n_events.h
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version V1.4.0
  * @date    26-July-2024
  * @brief   Header file for external uC - STM32WB05N in network coprocessor mode
...
#ifndef _STM32WB05N_EVENTS_H_
#define _STM32WB05N_EVENTS_H_
...
typedef struct Periodic_Advertising_Response_t_s {
   ...
   */
  uint8_t *Data;
} Periodic_Advertising_Response_t;
 ...
 * @retval None
 */
void hci_le_periodic_advertising_sync_established_v2_event(uint8_t Status,
                                                           uint16_t Sync_Handle,
                                                           uint8_t Advertising_SID,
                                                           uint8_t Advertiser_Address_Type,
                                                           uint8_t Advertiser_Address[6],
 ...
 * @retval None
 */
void hci_le_periodic_advertising_report_v2_event(uint16_t Sync_Handle,
                                                 int8_t TX_Power,
                                                 int8_t RSSI,
                                                 uint8_t CTE_Type,
                                                 uint16_t Periodic_Event_Counter,
 ...
 * @retval None
 */
void hci_le_periodic_advertising_sync_transfer_received_v2_event(uint8_t Status,
                                                                 uint16_t Connection_Handle,
                                                                 uint16_t Service_data,
                                                                 uint16_t Sync_Handle,
                                                                 uint8_t Advertising_SID,
 ...
 * @retval None
 */
void hci_le_periodic_advertising_subevent_data_request_event(uint8_t Advertising_Handle,
 ...
 * @retval None
 */
void hci_le_periodic_advertising_response_report_event(uint8_t Advertising_Handle,
                                                       uint8_t Subevent,
                                                       uint8_t Tx_Status,
 ...
 * @retval None
 */
void aci_gap_pairing_event(uint16_t Connection_Handle,
                           uint8_t Bonded);
/**
 * @}
 */
 ...
 * @retval None
 */
void aci_l2cap_cos_disconnection_complete_event(uint16_t Connection_Handle,
                                                uint16_t CID);
/**
 ...
 * @retval None
 */
void aci_l2cap_cos_flow_control_credit_event(uint16_t Connection_Handle,
                                             uint16_t CID,
                                             uint16_t TX_Credits,
 ...
 * @retval None
 */
void aci_l2cap_cos_sdu_data_tx_event(uint16_t Connection_Handle,
                                     uint16_t CID,
                                     uint16_t SDU_Length,
                                     uint16_t TX_Credit_Balance);
/**
 ...
 * @retval None
 */
void aci_l2cap_cos_reconfiguration_event(uint16_t Connection_Handle,
                                         uint8_t Event_Type,
                                         uint16_t Result,
                                         uint8_t Identifier,
                                         uint16_t Peer_MTU,
 ...
 * @retval None
 */
void aci_l2cap_cos_connection_req_event(uint16_t Connection_Handle,
 ...
 * @retval None
 */
void aci_l2cap_cos_connection_resp_event(uint16_t Connection_Handle,
                                         uint8_t Channel_Type,
                                         uint16_t Peer_MTU,
                                         uint16_t Peer_MPS,
                                         uint16_t Initial_Credits,
