/**
  ******************************************************************************
  * @file    stm32wb05n_hal_aci.h
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version V1.3.0
  * @date    06-Feb-2024
  * @brief   Header file for external uC - STM32WB05N in network coprocessor mode (hal_aci)
...
#ifndef _STM32WB05N_HAL_ACI_H_
#define _STM32WB05N_HAL_ACI_H_
 ...
 * @param[out] BTLE_Stack_variant Bitmask of BLE stack v4.x or later variants
...
tBleStatus aci_hal_updater_calc_crc(uint32_t Address,
                                    ...
                                    uint32_t *crc);
/**
 * @brief It gives device ID and cut version. See DIE_ID register.
 * @param[out] HW_Version It is the content of Die ID register.
 * @retval Value indicating success or error code.
 */
 ...
 *        Supported ranges: - (0x00,0x25): with  BLE stack version < 2.1
 *                          - (0x00,0xFF): with BLE stackversion >= 2.1 and extended packet length.      
 *        Values:
 *        - 0x00 ... 0xFF
