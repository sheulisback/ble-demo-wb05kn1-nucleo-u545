...
#define OCF_LE_READ_FILTER_ACCEPT_LIST_SIZE		0x000F
typedef PACKED(struct) _le_read_filter_accept_list_size_rp{
	uint8_t		status;
	uint8_t		size;
}  le_read_filter_accept_list_size_rp;
#define LE_READ_FILTER_ACCEPT_LIST_SIZE_RP_SIZE 2

#define OCF_LE_CLEAR_FILTER_ACCEPT_LIST			0x0010

#define OCF_LE_ADD_DEVICE_TO_FILTER_ACCEPT_LIST		0x0011
typedef PACKED(struct) _le_add_device_to_filter_accept_list_cp{
	uint8_t		bdaddr_type;
	tBDAddr 	bdaddr;
}  le_add_device_to_filter_accept_list_cp;
#define LE_ADD_DEVICE_TO_FILTER_ACCEPT_LIST_CP_SIZE 7

#define OCF_LE_REMOVE_DEVICE_FROM_FILTER_ACCEPT_LIST	0x0012
typedef PACKED(struct) _le_remove_device_from_filter_accept_list_cp{
	uint8_t		bdaddr_type;
	tBDAddr 	bdaddr;
}  le_remove_device_from_filter_accept_list_cp;
#define LE_REMOVE_DEVICE_FROM_FILTER_ACCEPT_LIST_CP_SIZE 7
...
/**
* Vendor specific event for STM32WB.
*/
typedef PACKED(struct) _evt_blue_aci{
  uint16_t ecode; /**< One of the STM32WB event codes. */
  uint8_t  data[VARIABLE_SIZE];
} evt_blue_aci;
