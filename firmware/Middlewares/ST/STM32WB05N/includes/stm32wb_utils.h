/**
  ******************************************************************************
  * @file    stm32wb_utils.h
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version V1.3.0
  * @date    06-Feb-2024
  * @brief   Header file for STM32WB05N utility functions 
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32WB_UTILS_H
#define __STM32WB_UTILS_H
...
/**
  * @brief  Get STM32WB hardware and firmware version
  ...
  * @retval int        It returns 0 if successful
  */
uint8_t getSTM32WBVersion(uint8_t *hw_version, uint16_t *fw_version);
   
#ifdef __cplusplus
}
#endif

#endif /*__STM32WB_UTILS_H */
