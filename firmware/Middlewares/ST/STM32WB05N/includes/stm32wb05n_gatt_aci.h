...
#ifndef _STM32WB05N_GATT_ACI_H_
#define _STM32WB05N_GATT_ACI_H_
...
/**
 * @brief Adds the Generic Attribute Profile service to the database. This
 *        command should be sent during initialization of the Bluetooth stack,
 *        before issuing any other GATT or GAP commands.
 * @param Characteristics This is a bit field indicating if a characteristic in
 *        the GATT service shall be added or not. bit 0: if set, the Service
 *        Changed Characteristic will be added to the GATT Service. Service
 *        Changed characteristic is required if service definitions may be
 *        added, changed, or removed. Otherwise it is optional.
 *        Flags:
 *        - 0x01: SERVICE_CHANGED_CHAR_BIT
 * @param[out] Service_Changed_Handle Handle of the Service Changed
 *             Characteristic. Characteristic value is at following handle.
 ...
 *        aci_gatt_srv_attribute_modified_event is generated when characteristic
 *        value is modified. - GATT_NOTIFY_WRITE_REQ_AND_WAIT_FOR_APPL_RESP:
 ...
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param Char_Value_Handle Handle of the characteristic value.
 * @param Sec_Level Minimum allowed security level to receive notifications or
 *        indications on the characteristic value.
 * @retval Value indicating success or error code.
 */
